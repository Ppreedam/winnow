    ...
    return (
        <div style={{ width: "90%", margin: "auto", paddingTop: "10px" }} >
            <div style={{ display: "flex", gap: "60px" }}>
                <div>
                    <p style={{fontSize:"17px",fontWeight:"550",fontFamily:"Rubik",lineHeight:"29.63px"}}>1,1016 % <br /> Funded</p> 
                </div>
                <div>
                    <p style={{fontSize:"17px",fontWeight:"550",fontFamily:"Rubik",lineHeight:"29.63px"}}>5,541 <br /> Backers</p>
                </div>
                <div>
                    <p style={{fontSize:"17px",fontWeight:"550",fontFamily:"Rubik",lineHeight:"29.63px"}}>19 <br /> Days to go</p>
                </div>
            </div>
