...
const ProgressBarcom = (props) => {
  ...
  const percentage_of_grow = ((Grow_amount / Total_investment) * 100).toFixed(
    2
  );
  ...
  return (
    <div style={{ width: "90%", margin: "auto", paddingTop: "10px" }}>
      ...
      >
        <div>
          <p>
            {Grow_amount} Cr/{Total_investment} Cr
          </p>
        </div>
        <div>
          <p>{percentage_of_grow}% Complete</p>
        </div>
      </div>
    </div>
  );
