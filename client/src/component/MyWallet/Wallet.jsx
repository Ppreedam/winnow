                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <div>
                    <p>
                      <b>Deposit </b>
                      <br />{" "}
                      <span style={{ color: "#a4d1ef" }}>January 5,2023</span>
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <div>
                    <p>
                      <b>Deposit </b>
                      <br />{" "}
                      <span style={{ color: "#a4d1ef" }}>January 15,2023</span>
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <div>
                    <p>
                      <b>Withdrawal</b>
                      <br />{" "}
                      <span style={{ color: "#a4d1ef" }}>January 20,2023</span>
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <div>
                    <p>
                      <b>Company A </b>
                      <br />{" "}
                      <span style={{ color: "#a4d1ef" }}>January 25,2023</span>
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <div>
                    <p>
                      <b>Company A </b>
                      <br />{" "}
                      <span style={{ color: "#a4d1ef" }}>January 29,2023</span>
                    </p>
                  </div>
                </div>
                <div>
