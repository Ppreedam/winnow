        ...
        <>
            <div className={style.mainbox}>
                ...
                <div className={style.secondbox}>
                    <p className={style.myportfolio_text_deco} style={{ fontSize: "35px" }}>My Portfolio</p>
                    <div style={{ display: "flex", gap: "10px", paddingBottom: "80px" }}>
                        <div className={style.current_value_box}>
                            <div><p>current value <br /> <span><b style={{ color: '#170F49' }}>₹ 3,90,220</b> </span></p></div>
                            <div style={{ display: "flex" }}>
                                {/* growth icon */}
                                <div style={{ borderRadius: "40%", backgroundColor: "white", height: "40%" }}>
                                    <img style={{ height: "25px", width: "25px" }} src="rise.png" alt="growth_icon" /></div>
                                <div><p><b>18%</b></p></div>
                            </div>
                        </div>
                        ...
                        <div className={style.my_asset_mainbox_firstbox}>
                            ...
                            <div className={style.company_box}>
                                <div style={{ display: "flex", gap: "10px" }}>
                                    ...
                                    <div><p><b>Company A </b><br /> <span style={{ color: "#a4d1ef" }}>₹1,50,200</span></p></div>
                                </div>
                                <div>
